...
$(document).ready(function() {
    ...
    function ToCart(foodNameClicked, foodQuantity, isVeg, singleFoodAmount) {
        ...
        if (food.length !== 0) {
            ...
            for (var i = 0; i < food.length; i++) {
                let cartTxt = '<div class="row cartContentRow"><div class="col-10"><div style="display:flex;"><p>' + food[i][0] + '</p> <p class="text-muted-small">' + food[i][3] + '<p></div><span>&#8377; ' + food[i][2] + '</span></p>  </div>  <div class="col-2"> <p class="text-muted-small"><span>&#8377;</span>' + food[i][1] * food[i][2] + '</p>  <span class="cartQuantity"> ' + ' <span> Qty : </span>' + food[i][1] + '</span> </div>  </div> <hr class="cartHr">';
        ...
        $('.totalAmountDiv').append('<span class="totalAmountText">TOTAL AMOUNT : </span><br/>' + '<span>&#8377;</span>' + totalAmount);
